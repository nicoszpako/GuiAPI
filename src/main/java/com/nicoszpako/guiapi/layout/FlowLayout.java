    ...
    public void organise(List<Widget> widgets, Rectangle boundaries, Rectangle padding) {
        if (!widgets.isEmpty()) {
            ...
            for (Widget widget : widgets) {
                ...
                if (currentOffsetX + widget.getMargin().getRight() + widget.getGeometry().getWidth() + widget.getBorder().getRight() > maxWidth - padding.getRight()
                ...
                currentOffsetX += widget.getGeometry().getWidth() + widget.getMargin().getRight() + widget.getBorder().getRight();
            }
